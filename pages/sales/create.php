...
<body>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: Arial, sans-serif; }
        ...
        .sales-form { width: 100%; max-width: 1200px; margin: auto; background: white; border: 1px solid #ccc; }
        .header { background: #3085c3; color: white; padding: 10px; display: flex; justify-content: space-between; align-items: center; }
        .voucher-info { padding: 15px; }
        .row { display: flex; align-items: center; margin-bottom: 10px; }
        .row label { width: 150px; font-weight: bold; }
        .row input { width: 300px; padding: 6px; border: 1px solid #ccc; border-radius: 4px; }
        .table-container { border-top: 1px solid #ccc; }
        table { width: 100%; border-collapse: collapse; table-layout: fixed; }
        colgroup col:first-child { width: 35%; }
        thead { background: #f2f2f2; }
        th, td { border: 1px solid #ddd; padding: 8px; text-align: left; }
        td input { width: 100%; border: none; outline: none; padding: 4px; }
        .bottom { display: flex; justify-content: space-between; padding: 15px; gap: 20px; }
        .narration { flex: 1; }
        .narration label { display: block; margin-bottom: 6px; font-weight: bold; }
        .narration textarea { width: 100%; height: 100px; resize: none; padding: 10px; border: 1px solid #ccc; }
        .summary { width: 260px; flex-shrink: 0; }
        .summary .field { display: flex; align-items: center; margin-bottom: 10px; }
        .summary label { width: 90px; font-weight: bold; font-size: 14px; }
        .summary input { flex: 1; padding: 6px; border: 1px solid #ccc; border-radius: 4px; }
        .footer { background: #eaeaea; padding: 10px 15px; display: flex; justify-content: space-between; align-items: center; border-top: 1px solid #ccc; }
        .btn-row { display: flex; gap: 8px; }
        .footer button { padding: 8px 20px; cursor: pointer; border: 1px solid #ccc; border-radius: 4px; background: white; }
        .footer button.save-btn { background: #3085c3; color: white; border-color: #3085c3; font-weight: bold; }
    </style>
