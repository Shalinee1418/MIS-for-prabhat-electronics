...
<body>
  ...
  <main class="main">
    ...
    <div class="login-container">
      ...
      <!-- Inline error message (shown by JS or PHP) -->
      <div class="error-msg <?php echo isset($error) ? 'show' : ''; ?>" id="errorMsg">
        <i class="ti ti-alert-circle" aria-hidden="true"></i>
        <span id="errorText">
          <?php echo isset($error) ? htmlspecialchars($error) : 'Please fill in all fields.'; ?>
        </span>
      </div>

      <!-- Form posts to your PHP auth endpoint -->
      ...
      <!-- Forgot password link (matches original) -->
  ...
  <script>
    ...
    /* Validate then submit the PHP form */
    function submitForm() {
      ...
      btn.innerHTML = '<i class="ti ti-loader" aria-hidden="true"></i> Logging in…';
